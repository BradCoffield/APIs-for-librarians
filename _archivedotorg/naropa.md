...
title: "Naropa Poetics Audio Archives"
author: "Brad Coffield"
author_email: "bcoffield@gmail.com" 
tags: naropa audio-and-video-collections
---
...
the
[Naropa University Archive Project's](https://archive.org/details/naropa&tab=about)
contents and then selects three from that list for display. It will select a new
set on each page load. The Naropa archive features poetry readings and lectures
from many prominent Beat (literary movement) figures like Allen Ginsburg and
Anne Waldman. There's a lot of great content!

This implementation would be great for a libguide page on the Beat literary
movement.
...
There is a general description below the entries that comes from the larger
description page at the Archive and which isn't necessary for the entries to
work.
...
* The HTML uses Bootstrap grid syntax to achieve the columns. LibGuides 2.0 is
  built on Bootstrap so you can paste this into the HTML/Rich Text area (code
  view) no problem.
...
{% highlight css linenos %} #naropa-row h3 + p { margin-bottom: 2em; margin-top:
...
.morelink { font-size: 12px; text-transform: lowercase; } {% endhighlight %}
